...
const profile: { name: string; href: string; current: boolean }[] = [
...
const Navbar: NextPage = () => {
    ...
    return (
        <Disclosure as="nav" className="bg-[#f6e3d7]">
            {({ open }) => (
                <>
                            ...
                            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                                ...
                                <div className="hidden sm:block sm:ml-6">
                                    <div className="flex space-x-4">
                                        {/* MAP THROUGH NAVIGATION OBJECT TO SHOW SITE NAVIGATION LINKS */}
                                ...
                                <Menu as="div" className="ml-3 relative">
                                    ...
                                    >
                                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                            {/* MAP THROUGH PROFILE OBJECT TO DISPLAY USER PAGES */}
                    ...
                    {isCartOpen ? <Cart isOpen={isCartOpen} /> : <div></div>}
                </>
            )}
        </Disclosure>
    );
