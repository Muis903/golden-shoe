...
const Contact: NextPage = () => {
    ...
    async function sendForm() {
        ...
        const { name, email, phone, message, isSendCopyEnabled } = form;
        ...
        const data: IContactForm = {
            ...
            phone: phone,
            message: message,
            isSendCopyEnabled: isSendCopyEnabled,
        };
            ...
            <section className="mb-32 text-gray-800">
                ...
                <div className="flex flex-wrap">
                    <div className="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
                        {/*
                          By default, every time when a form is submitted
                          the page refreshes after on button click.
                          In order to prevent the page to instantly refresh itself
                          if defining an event and calling preventDefault()
                          https://stackoverflow.com/questions/56986671/why-the-page-refresh-on-button-click-in-react
                        */}
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="grow ml-6">
                                        ...
                                        <p className="text-gray-500">
                                            customer_service@goldenshoe.uk
                                        </p>
                                        <p className="text-gray-500">
                                            +44 123 456 7890
                                        </p>
